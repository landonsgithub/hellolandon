      ...
      <section className={styles.background_wrapper}>
            <section className={styles.text_wrapper}>
              <div className={styles.header}>
                ...
                <p className={styles.header_text}>To work and add value long term within an innovative technolgy team.</p>
                <h3 className={styles.h_all}>Education</h3>
              ...
              <div className={styles.workexp}>
                <h3 className={styles.h_all}>WORK EXPERIENCE  </h3>
                <h4 className={styles.h_all}>PROGRAMMING</h4>
                <h5 className={styles.h_all}>CODING BOOTCAMP AND DEV PROJECTS	    	    2020 - Present</h5>
                <ul>
                  ...
                  <li className={styles.text}>Developed an inspiring concept and assembled team for a resturant point of sale system to execute as our coding bootcamp's final team project.</li> 
                  <li className={styles.text}>Acquired proficiency in valuabe front-end concepts including CSS modules, SASS, flex, useState, useEffect, useRef, React DOM, Routing and others. </li>
                ...
                <h5 className={styles.h_all}>CONSULTANT: BUSINESS STRATEGY AND MARKETING	    	    2020 ～5/mo contract</h5>
                <ul>
                  <li className={styles.text}>Consult and collaborate with a team of 3 founding partners to strategize and simultaneously develop infrastructure for a Chinese facing talent acquisition agency and western facing recruitment platform for 3 opportunly defined business sectors.</li> 
                  <li className={styles.text}>Created a large company website using digital ocean, wordpress and wordpress extensions.</li>
                  <li className={styles.text}>Developed beta framework towards building partnerships with international employers and advertising their opportunities to qualifying western young professionals.</li>  
                  <li className={styles.text}>Introduced strategic partnerships with local media agencies to trade content and advertising, cutting our marketing budget by 8,000rmb a month while generating greater exposure.</li> 
                ...
                <h5 className={styles.h_all}>CONSULTANT: FLAVOR CREATION AND MARKETING    		       2019 ～8/mo contract </h5>
                <ul>
                ...
                <h5 className={styles.h_all}>CONSULTANT: BUSINESS DEVELOPMENT AND MARKETING    	2019 ～6/mo contract </h5>
                <ul>
                  ...
                  <li className={styles.text}>Introduceed artists to project and manage illustration design of original story considering the physics of curriculum.</li>
                </ul>
              </div>
        </section>
      </section>
