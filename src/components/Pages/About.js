  ...
  return (
    ...
    <div className={styles.card_container}>
      ...
      <div className={styles.card0}>
          <h4 className={styles.card_title}>WELCOME<GiWaterGun /></h4>
          <hr/>
          <p className={styles.card_text}>Thanks for checking out my shiny new portfolio website filled with my unique experiences as a business starter and agent for hire in SouthWest China.</p>
        </div>
        ...
        <h4 className={styles.card_title}>NON-PROFIT<GiFishMonster /></h4>
          <hr/>
          <p className={styles.card_text}>With local partners, I opened and operated a small library and training center in a rural community outside of the city. It's still open today!</p>
          </div>
        ...
        <div className={styles.card6}>
          <h4 className={styles.card_title}>CONSULTING<GiGhost /></h4>
          <hr/>
        ...
        <div className={styles.card7}>
          <h4 className={styles.card_title}>COMMUNITY<GiDinosaurRex /></h4>
          <hr/>
          <p className={styles.card_text}>Building and engaging in community is a natural passion. The life of these projects encompass bringing people together in valuable experiences.</p>
        </div>
        ...
        <h4 className={styles.card_title}>GOODBYE CHINA<GiPlagueDoctorProfile /></h4>
          <hr/>
          <p className={styles.card_text}>I was unable to enter China after April 2020 due to border closure. Consequently, I had to leave many things behind including my projects.</p>
        </div>
